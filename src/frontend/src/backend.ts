...
export class Backend implements backendInterface {
    ...
    async createNextRound(arg0: string): Promise<Round> {
        if (this.processError) {
            try {
                const result = await this.actor.createNextRound(arg0);
                return from_candid_Round_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async createTournament(arg0: string, arg1: bigint | null): Promise<Tournament> {
        if (this.processError) {
            try {
    ...
    async reshuffleCurrentRound(arg0: string): Promise<Round> {
        if (this.processError) {
            try {
                const result = await this.actor.reshuffleCurrentRound(arg0);
                return from_candid_Round_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_MatchResult_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MatchResult): MatchResult {
...
function from_candid_Round_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Round): Round {
...
function from_candid_opt_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Round]): Round | null {
    return value.length === 0 ? null : from_candid_Round_n10(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        matches: from_candid_vec_n12(_uploadFile, _downloadFile, value.matches),
...
function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        result: from_candid_MatchResult_n15(_uploadFile, _downloadFile, value.result),
...
function from_candid_record_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        eliminationCount: value.eliminationCount,
        name: value.name,
